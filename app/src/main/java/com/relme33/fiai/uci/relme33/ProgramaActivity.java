            ...
            lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    switch (aux){
                        ...
                        case "UH":
                            showDialogWait();
                            Intent i7 = new Intent(ProgramaActivity.this,MapaActivity.class);
                        ...
                        case "TE":
                            showDialogWait();
                            Intent i8 = new Intent(ProgramaActivity.this,MapaActivity.class);
                        ...
                        case "EL":
                            showDialogWait();
                            Intent i9 = new Intent(ProgramaActivity.this,MapaActivity.class);
                        ...
                        case "LA":
                            showDialogWait();
                            Intent i10 = new Intent(ProgramaActivity.this,MapaActivity.class);
                        ...
                        case "La":
                            showDialogWait();
                            Intent i11 = new Intent(ProgramaActivity.this,MapaActivity.class);
